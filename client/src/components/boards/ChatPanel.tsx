...
export function ChatPanel({
  ...
  // Holds the teardown for an in-flight resize drag so we can also clean up on
  // unmount / window blur (mouseup can be lost outside the window).
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-testid="handle-chat-resize"
      />

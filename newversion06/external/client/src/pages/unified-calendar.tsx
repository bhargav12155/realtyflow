            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {apiScheduledPosts.filter((p: any) => !p.content || !p.content.trim()).length > 0 && (
                    <Button
                      variant="outline"
                    ...
                    >
                      {fixBlankPostsMutation.isPending ? (
                        ...
                        <><Wand2 className="w-4 h-4 mr-2" />Fix Blank Posts ({apiScheduledPosts.filter((p: any) => !p.content || !p.content.trim()).length})</>
                      )}
                    </Button>
                  )}

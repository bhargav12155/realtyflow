...
interface Notification {
  id: string;
  type: 'photo_generated' | 'video_created' | 'content_published' | 'social_post_scheduled' | 'notification' | 'avatar_group_created' | 'motion_added' | 'sound_effect_added' | 'avatar_ready' | 'training_status_update' | 'video_generation_complete' | 'video_generation_failed' | 'motion_complete' | 'look_generation_complete' | 'look_generation_failed' | 'sjinn_video_ready' | 'sora2_video_ready';
  title: string;
  message: string;
  link?: string;
  timestamp: string;
